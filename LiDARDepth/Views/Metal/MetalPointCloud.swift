...
final class CoordinatorPointCloud: MTKCoordinator {
    ...
    override func draw(in view: MTKView) {
        ...
        // Write the code here to write depth value and match it with index of 3
        // Create function which takes coordinates use the above code for writing function to write the code to print the depth coordinates from metal frame.
